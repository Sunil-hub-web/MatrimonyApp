...
import com.example.matrimonyapp.databinding.FragmentSelectedprofileBinding;
...
public class SelectedProfileFragment extends Fragment {

    FragmentSelectedprofileBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentSelectedprofileBinding.inflate(inflater,container,false);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.equals("200")){
                        ...
                        JSONArray jsonArray_profile = new JSONArray(selectedprofile);
