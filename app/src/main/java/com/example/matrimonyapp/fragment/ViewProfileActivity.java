...
import com.example.matrimonyapp.databinding.ActivityViewProfileBinding;
...
public class ViewProfileActivity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = ActivityViewProfileBinding.inflate(inflater,container,false);

        sessionManager = new SessionManager(getContext());
        getProfileDetails(sessionManager.getUSERID());
    ...
    public void getProfileDetails(String user_id){
